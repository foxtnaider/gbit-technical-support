                    ...
                    <form method="POST" action="{{ route('naps.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="latitude" class="block mt-1 w-full" type="text" name="latitude" :value="old('latitude')" required placeholder="-90 a 90" />
                                <x-input-error :messages="$errors->get('latitude')" class="mt-2" />
                            </div>
                            
                            <div>
                                <x-input-label for="longitude" :value="__('Longitud')" />
                                <x-text-input id="longitude" class="block mt-1 w-full" type="text" name="longitude" :value="old('longitude')" required placeholder="-180 a 180" />
                            ...
                            <div>
                                ...
                                <x-text-input id="reference_power" class="block mt-1 w-full" type="number" name="reference_power" :value="old('reference_power')" step="0.01" placeholder="-25.00" />
                            ...
                            <div>
                                ...
                                <x-text-input id="fdt_distance" class="block mt-1 w-full" type="number" name="fdt_distance" :value="old('fdt_distance')" step="0.01" />
            ...
            networkDeviceSelect.addEventListener('change', function() {
                ...
                fetch(`/naps/get-pon-numbers/${deviceId}`)
                    ...
                    .then(data => {
                        ...
                        // Contar cuántos PONs están disponibles
                        const availablePons = data.filter(pon => !pon.disabled).length;
                        ...
                        data.forEach(pon => {
                            ...
                            // Deshabilitar los PONs ocupados
                            if (pon.disabled) {
