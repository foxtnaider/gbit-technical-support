<div>
    ...
    <button 
        ...
        data-theme-toggle
        type="button" 
        class="flex items-center justify-center p-2 rounded-md transition-colors duration-200 bg-gray-100 text-gbit-blue-800 hover:bg-gray-200 dark:bg-gbit-blue-700 dark:text-white dark:hover:bg-gbit-blue-600"
